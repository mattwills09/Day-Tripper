$(document).ready(function () {
    ...
    function getPOIsCOORDS(category, lat, long) {
      ...
      $.ajax(settings).then(function (response) {
        ...
        //   getPOIdetails(yelpID); //send the id to getPOIdetails for a second api call
        // }
        console.log("$.ajax(settings) - locations: " + JSON.stringify(locations[0].id));
        console.log("$.ajax(settings) - response.business: " + JSON.stringify(response.businesses));
    ...
    function getPOIdetails(yelpID) {
      ...
      $.ajax(settings).then(function (response) {
        ...
        console.log("new POI response - yelpResults" + yelpResults);
...
//  Render search results on page    
  ...
  //$("p").text(searchArr);
  //console.log("click category - searchArr: " + searchArr);
  ...
  //searchArr.forEach(myFunction);
 
  //function myFunction(item, index) {
  //  console.log( "index[" + index + "]: " + item ); 
  //  getPOIsCOORDS(item, "39.9553076", "-75.1720374")
  //}
});
    /*** END YELP***/
